...
public static class OnlineStoreExampleWith_AbpEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE OnlineStoreExampleWith_AbpModuleExtensionConfigurator CLASS (in the Domain.Shared project)
