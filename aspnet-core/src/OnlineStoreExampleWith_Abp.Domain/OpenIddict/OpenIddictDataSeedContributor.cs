...
namespace OnlineStoreExampleWith_Abp.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("OnlineStoreExampleWith_Abp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "OnlineStoreExampleWith_Abp", DisplayName = "OnlineStoreExampleWith_Abp API", Resources = { "OnlineStoreExampleWith_Abp" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["OnlineStoreExampleWith_Abp_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["OnlineStoreExampleWith_Abp_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["OnlineStoreExampleWith_Abp_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["OnlineStoreExampleWith_Abp_Swagger:RootUrl"]?.TrimEnd('/');
